...
import type { Instance, NavSection, SidebarNavItem } from "@kanzo-tech/ui";

/**
 * One fake tenant's worth of data, shared by the scenes so they read as the SAME
 * product rather than three unrelated demos.
 */
...
export const NAV: SidebarNavItem[] = [
  { title: "Dashboard", href: "#/app", icon: <HomeIcon />, isActive: true },
  {
    title: "Data",
    icon: <DatabaseIcon />,
    items: [
  ...
  { title: "Quality", href: "#/app/quality", icon: <ShieldIcon /> },
  {
    title: "Settings",
    icon: <GearIcon />,
    items: [
...
export const SETTINGS_SECTIONS: NavSection[] = [
  {
    heading: "Workspace",
    items: [
      { href: "#/app/settings/cloud", label: "Cloud accounts", icon: <CloudIcon /> },
      { href: "#/app/settings/ai", label: "AI providers", icon: <BotIcon /> },
    ],
  },
  {
    heading: "Account",
    items: [
      { href: "#/app/settings/profile", label: "Profile", icon: <PersonIcon /> },
      { href: "#/app/settings/jobs", label: "Job defaults", icon: <BriefcaseIcon /> },
    ],
  },
];
