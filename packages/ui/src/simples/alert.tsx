...
export const alertVariants = tv({
  ...
  variants: {
    variant: {
      ...
      destructive: [
        "bg-destructive-a3",
        "border-destructive-a6",
        "[&_svg]:text-destructive",
        "[&_[data-slot=alert-action]_[data-variant=ghost]]:hover:bg-destructive-a4",
      ],
      info: [
        "bg-info-a3",
        "border-info-a6",
        "[&_svg]:text-info",
        "[&_[data-slot=alert-action]_[data-variant=ghost]]:hover:bg-info-a4",
      ],
      warning: [
        "bg-warning-a3",
        "border-warning-a6",
        "[&_svg]:text-warning",
        "[&_[data-slot=alert-action]_[data-variant=ghost]]:hover:bg-warning-a4",
      ],
      success: [
        "bg-success-a3",
        "border-success-a6",
        "[&_svg]:text-success",
        "[&_[data-slot=alert-action]_[data-variant=ghost]]:hover:bg-success-a4",
      ],
    },
  },
  defaultVariants: {
