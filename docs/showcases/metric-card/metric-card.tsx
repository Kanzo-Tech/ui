...
// behaviour, so it lives here as an arrangement you copy, not a component you import from
// `@kanzo-tech/ui`. The `card` page's four metric examples all pull it from this one
