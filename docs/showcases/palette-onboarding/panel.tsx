...
function Registration({ palette: p }: { palette: PaletteView }) {
  return (
    <>
      ...
      <Block
        hint="A failing gate adjusts and publishes what moved; the one it cannot adjust is published as relief. No heraldry here moves a step — all five halls' brands are legal exactly where the ramp puts them, so what they publish is relief and nothing else. Type a seed pair of your own above to see one pay."
        title="The record"
      >
