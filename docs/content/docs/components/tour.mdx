...
const steps: TourStepType[] = [
  ...
  },
  {
    ...
    description: "It becomes the graph id.",
    actions: [
...
buttons and `next` to a filled one. Use `TourPreviousStep` and `TourNextStep` directly when a
step needs its navigation laid out among other footer content.
