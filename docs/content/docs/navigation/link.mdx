...
This is a plain `<a>`. For router navigation, wear your framework's link with
[`asChild`](#a-router-link) — the design system deliberately knows nothing about any router.
