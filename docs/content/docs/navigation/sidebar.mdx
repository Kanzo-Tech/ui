...
[`@kanzo-tech/auth`](/docs/auth) is the sibling that owns the session behind such a row, and
[`Gate`](/docs/auth/roles#gate) is where the decision to draw one comes from.
</Callout>
