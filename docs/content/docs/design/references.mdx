...
description: The case law under one sentence — Ark owns behaviour, Shark owns surface, AI Elements is a source and not a reference, and a measurement overrules all of them.
---
...
[Conventions](/docs/conventions#the-reference-and-what-overrules-it) owns that sentence and the five
things it does not say on its own. This page is the case law under it: what it has actually decided,
and what would decide each of those the other way.

The reason it is *falsifiability*: a divergence has to be checkable by someone who was not in the
...
[Conventions](/docs/conventions#naming).
