...
The tree above is the composition you write. These ship as well, and they are the tier below it:
reach for them when you are rearranging the grid rather than using it.
